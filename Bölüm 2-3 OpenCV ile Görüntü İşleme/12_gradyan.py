...
# ddepth oyuputun derinliğini gösteriyor, dx=1 x yönünde yaptığımızı,
# dy=0 y yönünde yapmadığımızı gösteriyor.
plt.figure(), plt.imshow(sobelx, cmap="gray"), plt.axis("off"), plt.title("Sobel X")
# Dik kenarları tespit etmiş olduk

# y gradyan
sobely = cv2.Sobel(img, ddepth=cv2.CV_16S, dx=0, dy=1, ksize=5)
plt.figure(), plt.imshow(sobely, cmap="gray"), plt.axis("off"), plt.title("Sobel Y")
# Yatay kenarları tespit etmiş olduk
