...
maske_img_hist = cv2.calcHist([golden_gate], channels= [0], mask = mask, histSize = [256], ranges = [0,256])
print(maske_img_hist.shape)
plt.figure(), plt.plot(maske_img_hist)
