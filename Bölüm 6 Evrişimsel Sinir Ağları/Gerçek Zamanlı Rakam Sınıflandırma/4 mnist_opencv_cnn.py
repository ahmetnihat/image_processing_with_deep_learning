...
# Label sınıf sayımız 0-9 arasında 10 olmuş oluyor.
...
"""
# vis (veri içine bakıyoruz adetten :D)
...
#◘ preProcess işlemini tüm verimize uyguluyoruz.
...
# -1 dememizin sebebi boyutlarımız 32,32 olsun da resim kaç tane olursa ona göre ayarla demek
print(x_train.shape)
...
# padding same bir sıra piksel ekliyor.
