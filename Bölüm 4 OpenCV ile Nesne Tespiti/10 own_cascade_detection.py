...
# scale olsun, sonuc'un üstüne eklensin aralığı 400-1000 olsun
# ve bunu değiştirdikçe empty diye bir fonksiyon çağırsın
...
while True:
    ...
    if success:
        ...
        # detection
        rects = cascade.detectMultiScale(img_gray, scaleVal, neighbor)
